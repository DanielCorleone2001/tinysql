...
JoinTable:
	 ...
	 * joined_table: {
         ...
         *
	 */
| 	TableRef CrossOpt TableRef "ON" Expression // table1 [join | inner join] table2 on ....
	{
		$$ = &ast.Join{Left: $1.(ast.ResultSetNode),Right: $3.(ast.ResultSetNode),
				Tp: ast.CrossJoin, On: &ast.OnCondition{Expr: $5}}
	}
|	TableRef JoinType OuterOpt CrossOpt TableRef "ON" Expression // table1 [ [left| right] join | inner join] table2 on ....
	{
